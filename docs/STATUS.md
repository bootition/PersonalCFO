...
1. **FIXME 残余 = 用户定性队列**（规则已无能为力，须用户一次性定性）：支付宝金额占比 4.06%/笔数 15.07%（课程平台中高级首付/分期 12.2k、充值-普通充值 5.0k、家人/陈黔等人情转账 ~2k、小荷包 39 元）；微信 16.71%/13.75%（亲属自转 4.6k、家人转账收入 3.7k、生日/新年红包 1.5k、王琦 AA 0.7k）。定性问题清单已就绪，待用户批处理。
